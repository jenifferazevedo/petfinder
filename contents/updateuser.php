<?php 
if(isset($_SESSION['petfinder-user']) && is_array($_SESSION['petfinder-user'])) $values = $_SESSION['petfinder-user'];
else if (isset($_SESSION['petfinder-admin']) && is_array($_SESSION['petfinder-admin'])) $values = $_SESSION['petfinder-admin'];
else header('Location: ../index.php?pg=Home');
  //ligar a base de dados e enviar o $_SESSION['petfinder-user']['id'], pegar a resposta e retonar nos valores do input
?>
    ...
    <div class="col-lg-12">
      ...
      <form class="needs-validation" novalidate action="./database/updateuser.php" method="post">
        ...
        <div class="d-flex flex-row pb-5">
          ...
          <button class="btn d-flex ml-1 fading">Deletar</button>
        </div>
      </form>
      <script>

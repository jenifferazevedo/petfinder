...
?>
<?php if($id!==null): //ligar a base de dados e enviar o $_SESSION['petfinder-user']['id'], pegar a resposta e retonar nos valores do input?>
  <?php 
  ...
  <div id="cadastrouser" class="container pt-3 pb-5 fading">
    ...
    <div class="row justify-content-center my-5">
      <div class="col-8 card">
        ...
        <form action="delete" method="post" class="py-2 d-flex">

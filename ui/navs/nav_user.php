<div class="collapse navbar-collapse" id="navbarNavDropdown">
  <ul class="navbar-nav ml-auto d-flex align-items-center">
    ...
    ?>
      ...
      else echo'<div class="rounded-circle imageUser"><img src="'.$_SESSION['petfinder-user']['image'].'" onerror="this.onerror=null;this.src=\'./img/petfinderIcon.svg\';" alt="Foto Usuário"></div>' ?>
      </a>
